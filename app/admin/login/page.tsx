...
function LoginContent() {
  ...
  const handleLogin = () => {
    // Redirect to our server-side login initiation endpoint
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-lg max-w-sm w-full p-8 text-center">
        <h1 className="text-xl font-bold text-gray-900 mb-2">Capella KYC Admin</h1>
        <p className="text-sm text-gray-500 mb-6">管理员后台 / Admin Dashboard</p>
        ...
        <p className="mt-4 text-xs text-gray-400">
          Only @capella-capital.com accounts are allowed
        </p>
      </div>
    </div>
  );
